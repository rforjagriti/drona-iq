              ...
              <form className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input placeholder="Enter your name" className="h-12 rounded-xl bg-muted/30 border-none" />
                  </div>
                  <div className="space-y-2">
                    <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">Phone Number</Label>
                    <Input type="tel" placeholder="+91 XXXX" className="h-12 rounded-xl bg-muted/30 border-none" />
                  </div>
                </div>
                <div className="space-y-2">
                  <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">Interested In</Label>
                  <Input placeholder="NDA Foundation, Home Tuition, etc." className="h-12 rounded-xl bg-muted/30 border-none" />
                </div>
                <div className="space-y-2">
                  <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">Your Message</Label>
                  <Textarea placeholder="How can we help you?" className="min-h-[150px] rounded-xl bg-muted/30 border-none p-4" />
                </div>
                <Button className="w-full h-16 bg-primary text-white font-headline uppercase font-extrabold tracking-widest text-lg rounded-2xl shadow-xl">
                  Send Inquiry <Send className="ml-2 h-5 w-5 text-accent" />
                </Button>
              </form>
            </CardContent>
          </Card>
