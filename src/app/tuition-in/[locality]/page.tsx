        ...
        <div className="container mx-auto px-4 relative z-10 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
            <Link href="/academic-health-check">
              <Button size="lg" className="bg-accent hover:bg-accent/90 text-white font-headline text-lg px-10 h-16 rounded-full uppercase tracking-widest font-bold">Free AI Assessment</Button>
            </Link>
