          ...
          <div className="space-y-12">
            <div className="space-y-6">
              ...
              <p className="text-xl text-white/40 font-light leading-relaxed">
                A Dehradun student spends **600+ hours yearly** in traffic on Rajpur Road. We convert that fatigue into academic power.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="p-8 bg-white/5 border border-white/10 rounded-3xl">
                ...
                <p className="text-[10px] uppercase font-bold text-white/40 mt-2 tracking-widest">Yearly Travel Waste</p>
              </div>
              <div className="p-8 bg-white/5 border border-white/10 rounded-3xl">
                <p className="text-5xl font-black text-green-400">92%</p>
                <p className="text-[10px] uppercase font-bold text-white/40 mt-2 tracking-widest">Cognitive Retention</p>
              </div>
            </div>
          </div>

          <div className="relative">
            <Microscope className="absolute -right-20 -top-20 h-96 w-96 text-accent opacity-5" />
            <div className="grid gap-4">
              {[
                ...
                { l: "Success Probability", v: "+54% Shift", i: TrendingUp, desc: "Mathematical delta after DIQ intervention." }
              ].map((p, i) => (
